...
const PrincipalesAportes = () => {
    const [datos, setDatos] = useState();

    useEffect(() => {
        axios.get("/api/principalesA")
    ...
    return (<>
        ...
        <section className=" w-full min-h-[100vh] text-black bg-white pt-16 px-5">
            <h2 className=" text-xl font-bold uppercase text-slate-800">Principales aportes</h2>
...
export default PrincipalesAportes;